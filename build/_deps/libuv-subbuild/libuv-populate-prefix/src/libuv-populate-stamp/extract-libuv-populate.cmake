...
#
get_filename_component(filename "/home/mxqwthl/bitbot_cifx_demo/dependencies/libuv-1.47.0.zip" ABSOLUTE)
get_filename_component(directory "/home/mxqwthl/bitbot_cifx_demo/build/_deps/libuv-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-libuv-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-libuv-populate${i}")
