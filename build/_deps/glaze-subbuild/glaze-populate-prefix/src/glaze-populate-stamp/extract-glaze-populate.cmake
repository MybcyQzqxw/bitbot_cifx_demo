...
#
get_filename_component(filename "/home/mxqwthl/bitbot_cifx_demo/dependencies/glaze-2.5.2.zip" ABSOLUTE)
get_filename_component(directory "/home/mxqwthl/bitbot_cifx_demo/build/_deps/glaze-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-glaze-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-glaze-populate${i}")
