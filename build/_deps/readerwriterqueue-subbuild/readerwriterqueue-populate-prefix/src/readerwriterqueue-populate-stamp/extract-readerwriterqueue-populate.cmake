...
#
get_filename_component(filename "/home/mxqwthl/bitbot_cifx_demo/dependencies/readerwriterqueue-1.0.6.zip" ABSOLUTE)
get_filename_component(directory "/home/mxqwthl/bitbot_cifx_demo/build/_deps/readerwriterqueue-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-readerwriterqueue-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-readerwriterqueue-populate${i}")
