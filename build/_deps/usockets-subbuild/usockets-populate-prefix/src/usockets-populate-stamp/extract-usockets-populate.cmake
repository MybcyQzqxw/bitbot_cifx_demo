...
#
get_filename_component(filename "/home/mxqwthl/bitbot_cifx_demo/dependencies/uSockets-0.8.6.zip" ABSOLUTE)
get_filename_component(directory "/home/mxqwthl/bitbot_cifx_demo/build/_deps/usockets-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-usockets-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-usockets-populate${i}")
