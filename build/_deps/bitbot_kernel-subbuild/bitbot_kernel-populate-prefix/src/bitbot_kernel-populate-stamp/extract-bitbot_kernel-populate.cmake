...
#
get_filename_component(filename "/home/mxqwthl/bitbot_cifx_demo/dependencies/bitbot_kernel-main.zip" ABSOLUTE)
get_filename_component(directory "/home/mxqwthl/bitbot_cifx_demo/build/_deps/bitbot_kernel-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-bitbot_kernel-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-bitbot_kernel-populate${i}")
