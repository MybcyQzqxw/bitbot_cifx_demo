...
#
get_filename_component(filename "/home/mxqwthl/bitbot_cifx_demo/dependencies/uWebSockets-20.48.0.zip" ABSOLUTE)
get_filename_component(directory "/home/mxqwthl/bitbot_cifx_demo/build/_deps/uwebsockets-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-uwebsockets-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-uwebsockets-populate${i}")
